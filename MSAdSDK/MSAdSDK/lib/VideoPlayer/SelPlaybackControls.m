...
{
    MSWS(ws);
    [_playButton mas_makeConstraints:^(BWHXMASConstraintMaker *make) {
        make.center.equalTo(self);
        make.size.mas_equalTo(CGSizeMake(80, 80));
    }];
    
    [_bottomControlsBar mas_makeConstraints:^(BWHXMASConstraintMaker *make) {
        make.left.right.bottom.equalTo(self);
        make.height.equalTo(@30);
    }];
    
    [_activityIndicatorView mas_makeConstraints:^(BWHXMASConstraintMaker *make) {
        make.center.equalTo(self);
    }];
    
    [_retryButton mas_makeConstraints:^(BWHXMASConstraintMaker *make) {
        make.center.equalTo(self);
        make.size.mas_equalTo(CGSizeMake(80, 80));
    }];
    ...
    [_playTimeLabel mas_makeConstraints:^(BWHXMASConstraintMaker *make) {
        make.left.equalTo(ws.bottomControlsBar).offset(5);
        make.width.equalTo(@45);
        make.centerY.equalTo(ws.bottomControlsBar.mas_centerY);
    }];
    
    [_totalTimeLabel mas_makeConstraints:^(BWHXMASConstraintMaker *make) {
        make.right.equalTo(ws.fullScreenButton.mas_left).offset(-5);
        make.width.equalTo(@45);
        make.centerY.equalTo(ws.bottomControlsBar.mas_centerY);
    }];
    
    [_progress mas_makeConstraints:^(BWHXMASConstraintMaker *make) {
        make.left.equalTo(ws.playTimeLabel.mas_right).offset(5);
        make.right.equalTo(ws.totalTimeLabel.mas_left).offset(-5);
        make.height.equalTo(@2);
        make.centerY.equalTo(ws.bottomControlsBar.mas_centerY);
    }];

    [_videoSlider mas_makeConstraints:^(BWHXMASConstraintMaker *make) {
        make.edges.equalTo(ws.progress);
    }];
}
